...
public sealed class EvacShuttleTest
{
    ...
    public async Task EmergencyEvacTest()
    {
        ...
        var saltern = data.Grids.First(x => !entMan.HasComponent<Content.Server._Crescent.Procedural.Components.LavalandStationComponent>(x)); // Lavaland change - ignore lavaland outpost
