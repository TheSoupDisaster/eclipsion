...
namespace Content.Server.Kitchen.EntitySystems
{
    public sealed class MicrowaveSystem : EntitySystem
    {
        ...
        private void SubtractContents(MicrowaveComponent component, FoodRecipePrototype recipe)
        {
            ...
            var totalReagentsToRemove = recipe.IngredientsReagents.ToDictionary(static x => x.Key.Id, static x => x.Value);
        ...
        {
            var cookRating = args.GetRating(ent.Comp.MachinePartCookTimeMultiplier);
