...
using Content.Shared._Crescent.Weapons.Ranged.Events;
using Content.Shared._Crescent.Weapons.Ranged.Upgrades;
using Content.Shared._Crescent.Weapons.Ranged.Upgrades.Components;
using Content.Shared.Projectiles;
using Content.Shared.Weapons.Ranged.Systems;

namespace Content.Server._Crescent.Weapons.Ranged.Upgrades;
