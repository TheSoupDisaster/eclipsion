...
research-console-tree-prerequisite-legend = Lines: direct prerequisites
research-console-tree-tier = Tier { $tier }
research-console-tree-tier-range = Tier { $minimum }–{ $maximum }
research-console-tree-tier-gated = Tier { $tier } · { $percent }%
research-console-tree-tier-gated-tooltip = Tier { $tier } unlocks after researching { $required } of { $total } Tier { $previousTier } technologies ({ $percent }%). Current progress: { $researched }/{ $total }.
